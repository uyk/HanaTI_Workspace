...
%>
<div id = "login_modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style='background-color: white; padding:30px; height:fit-content; width:50%; min-width: 300px;'>
