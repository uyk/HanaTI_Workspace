	...
	public void eventRegist() {
		...
		enterB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				panel.frame.waitingPanel.tryEnterSelectRoom();
			}
		});
		// 새로운 방을 생성하는 메소드
		newRoomB.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				panel.frame.waitingPanel.createRoom();
			}
		});
		...
		whisperB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(panel.frame.waitingPanel.waitList.getSelectedIndex() != -1)
					reciever = panel.frame.waitingPanel.waitList.getSelectedItem();
				else
					reciever = panel.frame.waitingPanel.roomUserList.getSelectedItem();
