...
<div class="fixed-sidebar">
	<div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			<ul class="left-menu">
				<li>
					<a href="#" class="<%=application.getContextPath()%>/resources/js-sidebar-open">
						<svg class="olymp-menu-icon left-menu-icon"  data-toggle="tooltip" data-placement="right"   data-original-title="OPEN MENU"><use xlink:href="<%=application.getContextPath()%>/resources/icons/icons.svg#olymp-menu-icon"></use></svg>
					</a>
				</li>
				<li>
...
<div class="main-header main-header-wethear">
	...
	<img class="<%=application.getContextPath()%>/resources/img-bottom" src="<%=application.getContextPath()%>/resources/img/weather-bottom.png" alt="friends">
</div>
